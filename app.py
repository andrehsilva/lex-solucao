...
#
                ...
                ####################################################################################################
                #############################regras#################################################################
                #pdt = pdt[~((pdt['Marca'] == 'AZ') & (pdt['Bimestre'].str.contains('BIMESTRE')))]
                pdt = pdt[~((pdt['Marca'] == 'CONEXIA') & (pdt['Bimestre'].str.contains('BIMESTRE')))]
                pdt = pdt[~((pdt['Marca'] == 'MY LIFE') & (pdt['Bimestre'].str.contains('BIMESTRE')))]
                pdt['Marca'] = pdt['Marca'].str.replace('CONEXIA','DIGITAL')
                ...
                if (pdt['Marca'].str.contains('AZ').any()):    
                    ...
                    ##caso deixar a solução AZ sem marc[]                  #pdt['Marca'] = pdt['Marca'].str.replace('AZ','')
